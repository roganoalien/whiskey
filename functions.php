...
function your_themes_scripts(){
   ...
   wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/vendors/vendors.min.js' );
   wp_enqueue_script( 'mapfre-scripts', get_template_directory_uri() . '/js/main.min.js' );
}
